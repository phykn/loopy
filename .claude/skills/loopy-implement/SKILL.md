...
This is a Claude Code compatibility wrapper. Use the canonical runtime skill instructions in `../../../skills/loopy-implement/SKILL.md`.

Before implementing, also read the parent philosophy in `../../../skills/core.md` when it exists.
